  ...
  return (
    <div className="relative my-2 w-full max-w-96 flex-grow">
      ...
      <input
        ...
        name="search"
        placeholder="Search.."
        className="block w-full max-w-sm rounded-lg border border-gray-200 pl-12 pr-5 leading-6 placeholder-gray-500 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
        value={searchTerm}
